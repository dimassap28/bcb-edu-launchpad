...
const tags = [
  ...
  },
  {
    ...
    mPos: { bottom: "25%", right: "19%" },
    drift: { x: -14, y: 10, dur: 11 },
    delay: 1.2,
    rotate: -15,
  },
];
...
const reviews = [
  {
    quote:
      "BCB Edu benar-benar mengubah cara kami mengelola sekolah. Absensi yang dulu manual sekarang selesai otomatis. Guru-guru langsung bisa pakai dari hari pertama.",
    name: "Ibu Ratna Dewi",
    role: "Kepala Sekolah",
  ...
  {
    quote:
      "Jadwal tidak pernah bentrok lagi. Sistem otomatisnya sangat membantu staf TU dan membuat semua pihak lebih tenang.",
  ...
  {
    quote:
      "CBT-nya stabil untuk ratusan siswa sekaligus. Tidak ada kendala teknis sama sekali saat ujian berlangsung.",
  ...
  {
    quote:
      "Rekap absensi yang dulu makan waktu berjam-jam sekarang selesai otomatis. Sangat membantu operasional harian kami.",
...
const ReviewCard = ({
  ...
  <div className="relative bg-card border border-border rounded-[20px] p-6 md:p-8 flex flex-col justify-between h-full">
    ...
    <div>
      <span className="text-4xl font-serif leading-none text-primary mb-2 block select-none">
        "
      </span>
        ...
        <div className="flex flex-col md:flex-row md:items-start items-center gap-10 md:gap-12">
          ...
          >
            ...
            <div className="relative mb-8 text-center md:text-left">
              <h2 className="text-4xl md:text-[64px] font-extrabold text-foreground leading-[1.15] relative z-0">
                Apa Kata
                <br />
          ...
          <div className="md:w-[65%] min-w-0">
            ...
            >
              ...
              <div className="group h-full">
                <div className="flex flex-col gap-4 animate-[scroll-up_24s_linear_infinite] group-hover:[animation-play-state:paused]">
