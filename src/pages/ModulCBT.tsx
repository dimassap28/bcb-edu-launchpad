...
const ModulCBT = () => {
  ...
  const countedPrice = useCountUp(3000, 1200, pricingInView);
          ...
          <MChild variants={sectionVariants}>
            ...
            >
              <div className="flex items-center gap-3 mb-4 px-4 py-1.5 rounded-full bg-primary/10">
                ...
                <span className="text-primary text-xs font-semibold">Fitur Modul</span>
              </div>
            </motion.div>
            ...
            <div ref={pricingRef} className={`${cardHover} p-8 md:p-10 text-center`}>
              ...
              <div className="space-y-3 text-sm mb-6">
                <div className="flex justify-between py-2 border-b border-border">
                  ...
                  <span className="font-semibold">Rp 1.500.000 / tahun</span>
                </div>
                <div className="flex justify-between py-2 border-b border-border">
                  <span className="text-muted-foreground">1.000 siswa</span>
                  <span className="font-semibold">Rp 3.000.000 / tahun</span>
                </div>
              </div>
      ...
      <section className="bg-hero-gradient py-20">
        ...
        >
          ...
          <p className="text-primary-foreground/80 text-lg max-w-xl mx-auto mb-8">
            Jadwalkan demo gratis dan lihat langsung cara kerja modul CBT di sekolah Anda.
          </p>
