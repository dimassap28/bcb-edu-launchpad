...
import { SIZE_PRESETS, MODULES, FAQ_ITEMS } from "@/entities/pricing/data/pricing.data";
      ...
      <section className="pt-28 pb-12 bg-hero-gradient text-primary-foreground text-center">
        <div className="container mx-auto px-4">
          ...
          <motion.p
            ...
            className="text-primary-foreground/80 max-w-xl mx-auto mb-8"
          >
          ...
          <motion.div
            ...
            className="inline-flex items-center bg-primary-foreground/10 backdrop-blur-sm rounded-full p-1 gap-1"
          >
            <button
            ...
            <div className="space-y-8">
              ...
              >
                ...
                <p className="text-sm text-muted-foreground mb-6 ml-11">
                  Harga modul menyesuaikan jumlah siswa.
                </p>
              ...
              >
                ...
                <p className="text-sm text-muted-foreground mb-6 ml-11">
                  Centang fitur yang ingin Anda aktifkan.
                </p>
                ...
                <div className="space-y-3">
                  {MODULES.map((mod) => {
                    ...
                    return (
                      ...
                      >
                        <div className={cn(
                          "w-6 h-6 rounded-md border-2 flex items-center justify-center mt-0.5 shrink-0 transition-all",
                            ...
                            <div>
                              {isBundle && isSelected && (
                                <span className="text-xs text-muted-foreground line-through">
                                  {formatRupiah(originalPerStudent * studentCount * 1.1)}
                                </span>
                              )}
                    ...
                    {MODULES.filter((m) => selectedModules.includes(m.id) && !m.comingSoon).map((mod) => (
                      <div key={mod.id} className="flex items-center justify-between text-sm">
                        ...
                        <span className="font-semibold">
                          {mod.free ? "Rp 0" : formatRupiah(mod.pricePerStudent * studentCount)}
                        </span>
                      </div>
                    ))}
                  </div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              <motion.div
                ...
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true }}
                className="bg-card rounded-2xl border p-6 shadow-card"
              >
          ...
          <div className="grid md:grid-cols-[1fr_1.5fr] gap-12 items-start">
            ...
            >
              ...
              <p className="text-muted-foreground text-sm">
                See how our client school's have optimized their system by approximately 95%
              </p>
            </motion.div>
