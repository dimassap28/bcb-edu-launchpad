...
import { NAV_MODUL_ITEMS, NAV_LINKS } from "@/entities/landing";
          ...
          >
            <div className="relative z-10 flex flex-col items-center gap-8 h-full bg-gradient-to-b from-primary via-primary/95 to-secondary pt-24 pb-8 px-6">
              <div className="flex flex-col items-center gap-2 w-full">
                ...
                >
                  Modul
                  <ChevronDown className={`h-4 w-4 transition-transform duration-200 ${modulOpen ? "rotate-180" : ""}`} />
                </button>
